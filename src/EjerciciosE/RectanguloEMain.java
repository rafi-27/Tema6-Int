...
//        nuevo.imprimir();
        ...
        System.out.println("Nuevos metodos: ");
        RectanguloE nuevaPrueba = RectanguloE.crearRectangulo();
        nuevaPrueba.imprimir();

        RectanguloE nuevaDos = RectanguloE.crearRectangulo();
        nuevaDos.imprimir();
    }
}